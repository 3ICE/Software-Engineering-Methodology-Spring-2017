...
static class Collision {
  // POLYGON/POLYGON
  static public boolean polyPoly(PVector[] p1, PVector[] p2) {
  ...
  // POLYGON/LINE
  static private boolean polyLine(PVector[] vertices, float x1, float y1, float x2, float y2) {
  ...
  // LINE/LINE
  static private boolean lineLine(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4) {
  ...
  static private boolean polyPoint(PVector[] vertices, float px, float py) {
